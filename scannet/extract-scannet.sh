...
for dir in $scans_folder/*; do
    ...
    for file in $dir/*.sens; do
        python ScanNet/SensReader/python/reader.py --filename $file --output_path $dir --export_color_images --export_depth_images --export_pose --export_intrinsics --frame_skip 4 
    done
done
