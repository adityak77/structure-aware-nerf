...
@dataclass
class CustomScanNetDataParserConfig(DataParserConfig):
...
@dataclass
class CustomScanNet(DataParser):
    """ScanNet DatasetParser"""

    config: CustomScanNetDataParserConfig
